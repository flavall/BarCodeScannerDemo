...
public class MainActivity extends AppCompatActivity {
    ...
    public void handleClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_product:
                ...
                break;
            case R.id.btn_other:
                mode = "CODE_39,CODE_93,CODE128,DATA_MATRIX,CODABAR";
                break;
            default:
                return;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 1) {
            TextView status = findViewById(R.id.tv_stattus);
            ...
            if (resultCode == RESULT_OK) {
                ...
                status.setText("Sacn wurde abgebrochen");
    ...
    public class HoleDatenTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            final String requestUtl = baseUrl + strings[0] + ".json";
            StringBuilder result = new StringBuilder();
            URL url = null;

            try {
                url = new URL(requestUtl);
